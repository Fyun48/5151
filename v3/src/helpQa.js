...
export function defaultHelpQaItems() {
  return [
    ...
    },
    {
      ...
      answer: "可以。登入後到「我的」填行政區、租金、坪數、樓層、地址與公開聯絡方式，也可上傳最多 5 張 JPG／PNG／WebP 照片（每張 2MB）。同時最多 3 則、30 天後失效，新帳號需滿 24 小時。不是仲介、沒有私訊、不經手金錢。找房列表預設仍只顯示整層住家（與 591 相同）；若判定可能與 591 同一間，會標成需確認同屋源，不會自動刪掉。",
    },
    {
      id: "demand-wall",
      question: "需求專區是即時私訊嗎？",
    ...
    },
    {
      ...
      answer: "會，但預設仍以 591 為主。管理員可另外打開住商、信義、5168、租租通：系統只抓該區租屋摘要，點進去是原站頁面，不是完整鏡像。樂屋被 Cloudflare 擋住、好房網列表封包尚未接通，打開也不會抓。跨站若像同一間，會標成需確認同屋源，不會自動刪掉。這是免費找房工具，不是仲介、不經手金錢。",
    },
    {
      id: "not-broker",
      question: "這是仲介或成交平台嗎？",
