...
export function defaultHelpQaItems() {
  return [
    ...
    },
    {
      ...
      answer: "檢查間隔是全站共用節奏，一般會員固定約每 8 分鐘、贊助會員約每 5 分鐘。行政區與條件按「儲存」後就會依這些節奏自動抓取與篩選，一般會員沒有「立即檢查」。畫面上只看得到說明，不能自行改短，避免對 591 造成過重負擔。管理員才能改間隔、每次抓取頁數、確認下架天數，以及手動立刻檢查。",
    },
    {
    ...
    },
    {
      ...
      answer: "可以。登入後到「我的」填行政區、可使用坪數（扣除公設）、樓層、路名與房屋特質（點選即可，不必填 591 那種長表）。社區大樓可標中庭、陽台。電話與 LINE 選填。說明最多 500 字，可套用樣式。必須勾選屋主／代理人聲明。同時最多 3 則、30 天後失效，新帳號需滿 24 小時。平台會抽查，不實刊登會下架並暫停上傳 14 天。這不是仲介認證、不保證真實。找房列表預設仍只顯示整層住家；房客可選「有中庭／有陽台」，只會篩站內刊登。",
    },
    {
      id: "demand-wall",
      question: "需求專區是即時私訊嗎？",
    ...
    {
      id: "notify-page",
      question: "「通知」這一頁是做什麼的？為什麼設定不在「我的」？",
      answer: "通知頁是待看更新與通知設定的集中處：上面是待看清單，下面可改系統推播、通知種類、Discord 與自己的 SMTP。「我的」改放個人資料、帳號與自行刊登。",
    },
    {
      id: "profile-nick",
      question: "暱稱會用在哪裡？",
      answer: "你在「我的」填的暱稱，會出現在帳號列、需求牆與回覆。沒填暱稱時，需求牆仍只顯示遮罩後的信箱。系統沒有即時私訊。",
    },
    {
      id: "self-verify",
