...
export function ensurePersonalSchema(db) {
  ...
  for (const sql of [
    ...
    "ALTER TABLE user_events ADD COLUMN notify_decide TEXT NOT NULL DEFAULT ''",
    "ALTER TABLE user_events ADD COLUMN notify_reason TEXT NOT NULL DEFAULT ''",
    "ALTER TABLE user_events ADD COLUMN notify_retry_count INTEGER NOT NULL DEFAULT 0",
    "ALTER TABLE user_events ADD COLUMN notify_last_error TEXT NOT NULL DEFAULT ''",
    "ALTER TABLE user_events ADD COLUMN notify_next_at INTEGER",
    "ALTER TABLE user_events ADD COLUMN notify_ready_at INTEGER",
    "ALTER TABLE user_events ADD COLUMN notify_coord_version INTEGER NOT NULL DEFAULT 0",
    "ALTER TABLE user_events ADD COLUMN dock_job_state TEXT NOT NULL DEFAULT ''",
    "ALTER TABLE user_events ADD COLUMN line_job_state TEXT NOT NULL DEFAULT ''",
    "ALTER TABLE user_events ADD COLUMN email_job_state TEXT NOT NULL DEFAULT ''",
    "ALTER TABLE user_events ADD COLUMN push_job_state TEXT NOT NULL DEFAULT ''",
    "CREATE INDEX IF NOT EXISTS idx_user_events_pending_claim ON user_events(notified, notify_decide, notify_next_at, id)",
    `CREATE TABLE IF NOT EXISTS user_same_house_members (
      user_id INTEGER NOT NULL,
      group_key TEXT NOT NULL,
      post_id INTEGER NOT NULL,
