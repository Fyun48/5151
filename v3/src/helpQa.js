...
export function defaultHelpQaItems() {
  return [
    ...
    },
    {
      ...
      answer: "可以。登入後到「我的」填行政區、可使用坪數（扣除公設）、樓層、路名與房屋特質（點選即可，不必填 591 那種長表）。電話與 LINE 選填。說明最多 500 字，可套用樣式。必須勾選屋主／代理人聲明。同時最多 3 則、30 天後失效，新帳號需滿 24 小時。平台會抽查，不實刊登會下架並暫停上傳 14 天。這不是仲介認證、不保證真實。找房列表預設仍只顯示整層住家。",
    },
    {
      id: "demand-wall",
      question: "需求專區是即時私訊嗎？",
