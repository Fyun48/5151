...
| 取消後的剩餘工作可確認結果 | 本輪已做 | `ops/src/cancelResult.js` `describeCancelResultOffer` `confirmCancelResult`、未決清單 | 第 29 包；已取消且仍有 branch／PR／測試站／供應商工作才列出；確認只寫觀察，不自動清理、不改寫 cancelled；沒有剩餘工作的取消不進未決清單 |
