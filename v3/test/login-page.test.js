...
test("login page can register after accepting the disclaimer", () => {
  ...
  assert.match(html, /用 \$\{list\} 註冊/);
  assert.match(html, /function paintOauthButtons/);
  assert.match(html, /el\.hidden = !on/);
  assert.match(html, /forgot \|\| !oauthOnNames\.length/);
  assert.match(html, /正在確認社群登入/);
  assert.match(html, /aria-disabled/);
  assert.match(html, /role="alert"/);
  assert.match(html, /tabindex/);
  assert.match(html, /id="oauthGoogle"[^>]*hidden/);
  assert.match(html, /id="oauthBox" hidden/);
