...
async function googleDirectionsRaw(fromLat, fromLng, toLat, toLng, { departureTime = 0, mode = "scooter" } = {}) {
...
async function googleDirections(fromLat, fromLng, toLat, toLng, opts = {}) {
  if (!googleDirectionsAllowed()) return null;
